...
export default class LeapKeyboard {
	...
	Leap.loop(controllerOptions, function(frame) {
	  ...
	  if (frame.pointables.length > 0) {
	    ...
	    //for (var i = 0; i < frame.pointables.length; i++) {
	      ...
	      outputContainer.innerHTML = curl(pointable.bones[3].direction()[2], pointable.bones[0].direction()[2]);
	    //}
	  }
	  else {
	...
	function curl(distalPhalanxZ, metacarpalBoneZ) {
	  return distalPhalanxZ - metacarpalBoneZ;
	}

	function listenForThreshold() {
